...
const bigFileOut = path.join(__dirname, 'lattice/encBigFile.txt')

const emptyFile = path.join(__dirname, 'lattice/empty.txt')
const plaintextStdin = 'someTextHere'
const alicePlaintextFile = path.join(__dirname, 'lattice/toAlice.txt')
const bobPlaintextFile = path.join(__dirname, 'lattice/toBob.txt')
